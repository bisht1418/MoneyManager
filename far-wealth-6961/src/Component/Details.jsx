        ...
        <Stack spacing={{ base: 6, md: 10 }}>
          ...
          >
            <VStack spacing={{ base: 4, sm: 6 }}>
              ...
              <Text fontSize={"lg"}>
                bringing increased value to merchants, merchant aggregators and
                marketplaces around the world. Join our Partner Ecosystem
                today.Becoming a Chargebee partner enables access to the world
                of subscriptions
              </Text>
            </VStack>
            <Box>
